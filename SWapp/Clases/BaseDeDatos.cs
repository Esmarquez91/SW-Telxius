...
namespace SWapp.Clases
{
    ...
    {
        public static string connSTr = "Server=tcp:samuelserver1.database.windows.net,1433;Initial Catalog=SamuelBD;Persist Security Info=False;User ID=samuel.marquez91;Password=Stark0638*;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
