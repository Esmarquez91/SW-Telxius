...
namespace SWapp.Clases
{
    class Funciones
    {
        ...
        public static void EnviarEmail(string cliente2,string tiponotif, string Asunto, CheckBox CB1, string TablaCircuitos, TextBox SCHEDULE, TextBox SCHEDULEupdate,string TicketID, string Descript, string Impacto, string Localidad,string TIPOIMPACT,RichTextBox R)
        {
            try
            {
