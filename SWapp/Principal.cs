    ...
    public partial class Principal : Form
    {
        ...
        private void LlenarCampos()
        {
            ...
            foreach (string webline in TxtBoxCorreo.Lines)
            {
                ...
                else if (webline.Split(':').Count() == 3)
                {
                    TextBoxSchedule.Text = webline.Substring(0, 12) + " " + webline.Substring(12, 5) + " " + webline.Substring(17, 1) + " " + webline.Substring(18, 12) + " " + webline.Substring(30, 5);
                    break;
                }
            }
            ...
            else if(TextBoxSchedule.Text.Length >= 2 || TextBoxScheduleUpdate.Text.Length >= 2)
            {
                ...
                try
                {
                    foreach (DataRow cid2 in CircuitosMultiLine.Rows)
                    {
                        ...
                        else if ((cliente != cliente2) && (Files.dtcliente.Select("CRT = '" + CID + "'", "CRT").Length > 0))
                        {
                            ...
                            if (TABLACID2.Rows.Count > 0) { Funciones.EnviarEmail(cliente2, tiponotif, Asunto, CheckBoxUpdate, TablaCircuitos, TextBoxSchedule, TextBoxScheduleUpdate, TicketID, Descript, Impacto, Localidad, ComboBoxImpacto.Text, RichTextAlertas); }
                ...
                try
                {
                    if (TABLACID2.Rows.Count > 0) //Notifica al ultimo cliente.
                    {
                        ...
                        Funciones.EnviarEmail(cliente2, tiponotif, Asunto, CheckBoxUpdate, TablaCircuitos, TextBoxSchedule, TextBoxScheduleUpdate, TicketID, Descript, Impacto, Localidad, ComboBoxImpacto.Text, RichTextAlertas);
                        if (cliente2 != "TIWS SL") { TABLACID2.Columns.Add("IP Service Identifier"); }
